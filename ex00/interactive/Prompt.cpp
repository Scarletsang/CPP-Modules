...
namespace interactive
{
  ...
  void  Prompt::register_action(std::string match, ActionFunc action)
  {
  ...
  void  Prompt::set_reprompt(std::string string)
  {
    reprompt_ = string;
  }

  void  Prompt::set_prompt(std::string string)
  {
    prompt_ = string;
  }
  ...
  int Prompt::run_multiple_choice(Data& states)
  {
    print_prompt();
  ...
  int Prompt::run_form(Data& states)
  {
